...
class Libary {
    ...
    private var gameArray: [Game] = [Game(title:"Legend of Zelda Breath of The Wild"), Game(title:"Dark Souls"), Game(title:"Fallout"), Game(title: "UFC 2"), Game(title: "Minecraft"), Game(title: "Grand Theft Auto V"), Game(title: "Call of Duty Black Ops III"),Game(title: "Skyrim")]
